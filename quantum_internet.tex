...
\end{align}
where $\oplus$ is the bitwise XOR operation (equivalently addition modulo 2) and $s$ represent the different bit-strings.
...
\item Depending on the choice of basis, she encodes her bit as:
\begin{align}
