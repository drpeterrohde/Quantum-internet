...
\def\pubmode{2} 			% Publication style
...
\hypersetup{
	...
	pdfkeywords = {Quantum, Computing, Information, Networks, Internet}
}
...
\if 1\QIPlink
	\title{\huge{The Quantum Internet --- A New Frontier}\\ \large{\QIhomepage}}
\else
