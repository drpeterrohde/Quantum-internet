...
\caption{The topology of an ethernet network, whereby all users share a common channel, which they can broadcast on at their leisure. If data packets collide, it is detected via the packets' checksums, and the corrupted packets may be re-broadcast after a random waiting period, repeating this process until packet delivery is successful.} \label{fig:ethernet}
\end{figure}
...
\comment{Need system with long coherence lifetime}
