...
\comment{TO DO. Talk about t1, t2 and t2* times in these sections}
...
\comment{To do - this is a lead-up to the next section. Introduce Bell pair distribution and error models. This leads directly into the entanglement purification section. Talk about effect of dephasing on entanglement metric. Treat entanglement as the `resource' that we want to communicate.}
