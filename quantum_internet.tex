...
Already today, even before the advent of useful quantum computation, we are seeing the emergence of the outsourced model for computation. IBM recently made an elementary 5-qubit quantum computer freely available for use via the cloud. Interested users can log in remotely, upload a circuit description for a quantum protocol, and have it executed remotely, with the results relayed back in real-time to the user. This simple development already makes experimentation with elementary quantum protocols accessible to the poor layman, opening up research opportunities to people who otherwise would have been priced out of the market.
