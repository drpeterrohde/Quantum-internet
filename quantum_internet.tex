...
\item Prepare this 4-qubit resource state - \mbox{$\ket\chi=\hat{\mathrm{CNOT}}_{2,3}\ket{\Psi^+}_{1,2}\ket{\Psi^+}_{3,4}$} - offline in advance.
...
\begin{align}
\Qcircuit @C=1em @R=1.6em {
\lstick{\ket\alpha} & \qw & \multimeasureD{1}{\text{Bell}} & \cw & \cw & \control \cw \\
...
\lstick{\ket\beta} & \qw & \ghost{\text{Bell}} & \cw  & \control \cw \cwx
} \nonumber
\end{align}
}}
