...
\subsection{Outsourced computation}
...
\subsection{Distributed computation} \label{sec:dist_QC}
...
\subsection{Encrypted computation} \label{sec:homo_blind}
...
\subsection{Modularised computation}
