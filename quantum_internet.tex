...
\begin{enumerate}
    \item A Russian bedroom hacker with no direct access to the required technology, delegates a factorisation algorithm to the cloud using homomorphic encryption.
    ...
    \item Unless they switch off the entire quantum internet, they can't prevent it from happening again in the subsequent election.
