...
t_i &= \alpha \beta^{n_i},
\end{align}
where $\alpha$ and \mbox{$\beta>1$} are constants specific to the algorithm being deployed, and the computational model (e.g cluster states vs the circuit model).
