...
Bell states (Eq.~\ref{eq:bell_basis}), maximally-entangled two-qubit states, are particularly useful for many applications, including quantum teleportation (see Sec.~\ref{sec:teleport}), cluster state preparation (see Sec.~\ref{sec:CSQC}), and entanglement swapping (see Sec.~\ref{sec:repeater}). Bell states are the special case of two-qubit cluster states, or equivalently, two-qubit GHZ states.
