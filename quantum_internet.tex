...
into
\begin{align}
\ket\psi_R=\alpha\ket{000}+\beta\ket{111}.
\end{align}
...
In the graph, vertices represent qubits initialised into the \mbox{$\ket{+}=\frac{1}{\sqrt{2}}(\ket{0}+\ket{1})$} state, and edges represent the application of maximally entangling controlled-phase (CZ) gates between vertices, given by,
\begin{align}
