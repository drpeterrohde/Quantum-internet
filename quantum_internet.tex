...
%\if 1\QIPlink
%	\title{\huge{The Quantum Internet --- The Second Quantum Revolution}\\ \large{\href{http://www.quantum-internet.tech}{www.quantum-internet.tech}}}
%\else
	\title{The Quantum Internet --- The Second Quantum Revolution}
%\fi
