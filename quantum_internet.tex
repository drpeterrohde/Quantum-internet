...
\item Solving linear systems of equations \cite{bib:harrow2009quantum, berry}, with widespread applications in linear algebra.
...
\\
\\
P.P.R conceived this project, developed the original ideas, prepared most of the manuscript, and directed the project. Z.E.S and H.L.H prepared Sec.~\ref{sec:state_of_the_art}. S.I.M contributed to Sec.~\ref{sec:classical_nets}. R.L.M contributed to Sec.~\ref{sec:protocols_quant_int}. All authors played active roles in the discussions that developed this work.
