...
\subsubsection{Traffic management \& routing }\index{Traffic management}\index{Routing}
...
\paragraph{Traffic management}\index{Traffic management}
...
\paragraph{Routing}\index{Routing}
...
\paragraph{Congestion control}\index{Congestion control}
...
\subsubsection{Quantum-enhanced machine learning overview}\index{Quantum machine learning}
