...
In quantum dots, the recombination of an electron-hole pair\index{Electron-hole pair}, known as an \textit{exciton}\index{Exciton}, emits a single photon. Photon sources based on this concept are rapidly gaining popularity in present-day labs, and a summary of developments in this area is provided in Tab.~\ref{tab:quantum_dots}.
