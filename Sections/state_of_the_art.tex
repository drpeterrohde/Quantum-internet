...
\sectionby{He-Liang Huang \& Zu-en Su}
...
\begin{table*}[!htbp]
	\begin{tabular}{|p{0.755\linewidth}|p{0.22\linewidth}|}
		...
		\hline
	\end{tabular}
	\captionspacetab \caption{Major milestones in the development of quantum computation.\comment{Add White/OBrien 2qubit CNOT photonic gate.}} \label{tab:quantumcomputer}
\end{table*}
