...
\index{Nanosatellite @\also{Microsatellite}|gobbleone}
\index{Microsatellite @\also{Nanosatellite}|gobbleone}
...
\index{Micro-cluster states @\also{Star micro-cluster states, +-micro-cluster states, linear micro-cluster states, snowflake micro-cluster states}|gobbleone}
\index{Star micro-cluster states @\also{Micro-cluster states}|gobbleone}
\index{+-micro-cluster states @\also{Micro-cluster states}|gobbleone}
