...
\index{Thermal noise \seeonly{Errors}|gobbleone}
\index{Enigma machines \seeonly{Quantum Enigma machines}|gobbleone}
\index{Elasticity of supply \seeonly{Elasticity}|gobbleone}
\index{Elasticity of demand \seeonly{Elasticity}|gobbleone}
\index{Ledger \seeonly{Distributed ledger}|gobbleone}
\index{Synthetic aperture \seeonly{Quantum-enhanced telescopy}|gobbleone}
...
\index{Singlet state \seeonly{Bell states}|gobbleone}
\index{Triplet state \seeonly{Bell states}|gobbleone}
...
\index{Nano-satellite @\also{Micro-satellite}|gobbleone}
\index{Micro-satellite @\also{Nano-satellite}|gobbleone}
...
\index{Quantum error correction (QEC) @\also{3-qubit code, 9-qubit code, topological codes, unitary error averaging}|gobbleone}
...
\index{Time-dependent quantum computational leverage @\also{Quantum computational leverage}|gobbleone}
\index{Quality of service @\also{Quantum error correction, entanglement purification}|gobbleone}
