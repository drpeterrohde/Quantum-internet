...
The theme music for this work may be found \href{http://soundcloud.com/peter-rohde/wir-sind-ein-volk}{here} \copyright\index{Theme music}\footnote{We use the copyright (\copyright) and trademark (\texttrademark) symbols liberally throughout this text when referring to things where we believe commercial opportunities may exist in the future. The authors do not own copyrights or trademarks to anything in this text.}.