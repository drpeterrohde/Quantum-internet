...
\begin{figure}[!htbp]
	\includegraphics[clip=true, width=0.475\textwidth]{loss_LO_commutation}
	\captionspacefig \caption{Commutation of a uniform loss channel (i.e identical efficiency on each mode), $\mathcal{E}^\mathrm{loss}$, through a passive linear optics network, $\hat{U}$.} \label{fig:loss_LO_commutation} \index{Loss!Commutation}
\end{figure}

% Single-photon encoding

\subsubsection{Single-photon encoding}\index{Single-photons!Encoding}
...
\begin{figure}[!htbp]
	\includegraphics[clip=true, width=0.475\textwidth]{NOON_loss}
...
\subsection{Depolarisation} \index{Depolarising channel} \label{sec:depolarising_channel}
