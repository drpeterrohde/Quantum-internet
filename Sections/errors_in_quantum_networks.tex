...
The degree of amplitude damping is often quoted in terms of a channel's $T_1$-time\index{T$_1$-time}, characterising the expected time for the excited state to undergo spontaneous emission and relax to the ground state. Using this parameterisation we can express the amplitude damping channel as,
\begin{align}
...
\begin{align}
\hat\rho_t = \left(\begin{matrix}{}
1 + (\alpha-1) e^{-t/T_1} & \gamma e^{-t/T_1} \\
