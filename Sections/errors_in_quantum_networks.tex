...
\begin{align}
&\hat\rho_\mathrm{loss} = \mathcal{E}_\eta^\mathrm{loss}(\ket{\mathrm{cat}_+(\alpha)}\bra{\mathrm{cat}_+(\alpha)}) \nonumber\\
&= {\mathcal{N}_+}^2 [\mathcal{E}_\eta^\mathrm{loss}(\ket{\alpha}\bra{\alpha}) + \mathcal{E}_\eta^\mathrm{loss}(\ket{-\alpha}\bra{-\alpha}) \nonumber\\
&+ \mathcal{E}_\eta^\mathrm{loss}(\ket{-\alpha}\bra{\alpha}) + \mathcal{E}_\eta^\mathrm{loss}(\ket{\alpha}\bra{-\alpha})]\nonumber\\
&= {\mathcal{N}_+}^2[\ket{\eta\alpha}\bra{\eta\alpha} + \ket{-\eta\alpha}\bra{-\eta\alpha}\nonumber\\
&+e^{-2|(1-\eta)\alpha|^2}(\ket{\eta\alpha}\bra{-\eta\alpha}+\ket{-\eta\alpha}\bra{\eta\alpha})].
\end{align}
Now it's evident that the off-diagonal terms (i.e those representing coherence) accumulate a factor of,
\begin{align}
C=e^{-2|(1-\eta)\alpha|^2},	
\end{align}
...
\begin{figure}[!htbp]
	\includegraphics[clip=true, width=0.475\textwidth]{cat_decoherence}
	\caption{Coherence factor in an even-parity cat state subject to decoherence via loss, as a function of efficiency $\eta$, and the coherent amplitude $\alpha$.}\label{fig:cat_decoherence}
\end{figure}
