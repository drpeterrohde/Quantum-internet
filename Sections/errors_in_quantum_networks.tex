...
A qubit dephasing channel is often quoted in terms of its $T_2$-time\index{T$_2$-time}, a characteristic time for dephasing to occur under continuous time-evolution. Specifically, the probability of no dephasing occuring scales as,
\begin{align}
p_\mathrm{no\,error} = e^{-\frac{t}{T_2}},	
\end{align}
yielding a the equivalent dephasing channel,
\begin{align}
\mathcal{E}_t^\mathrm{dephasing}(\hat\rho) = e^{-\frac{t}{T_2}} \hat\rho + \frac{1}{2}(1-e^{-\frac{t}{T_2}})(\hat\rho + \hat{Z}\hat\rho\hat{Z}),
\end{align}
as shown in Fig.~\ref{fig:T2_time}.
