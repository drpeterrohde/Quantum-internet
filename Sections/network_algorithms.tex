...
\begin{mdframed}[innertopmargin=3pt, innerbottommargin=3pt, nobreak]
\texttt{
function ConstrainedShortestPath($G$,$A$,$B$):
\begin{enumerate}
	\item For the set of nearest-neighbour constraints, generate the set of edges $E_c$ that violate the constraints.
	\item $G'=G-E_c$
