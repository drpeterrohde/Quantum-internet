...
\begin{figure}[!htbp]
	\includegraphics[clip=true, width=0.475\textwidth]{complexity_classes}\index{Complexity classes} \index{P}\index{BPP} \index{NP \& NP-complete} \index{BQP} \index{\#P} \index{EXP}
