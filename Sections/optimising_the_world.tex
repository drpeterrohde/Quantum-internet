...
In this version of the map colouring problem, a valid colouring specifies a set of transmission frequencies that avoid interregional interference, and the chromatic number specifies the smallest possible radio spectrum\index{Radio spectrum} that must be allocated to the stations\footnote{Spectrum is worth a lot of money!}.
