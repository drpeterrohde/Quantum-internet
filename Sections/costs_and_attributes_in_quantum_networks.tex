...
\begin{align}
C_\text{ent} = \lim _{n-> \infty} \frac{1}{n}\chi(\mathcal{E}^{\otimes n})
\label{eq:ent_ent}
\end{align}
...
\begin{align}
\mathcal{C}_E(\mathcal{E}) = \max_{p_i,\rho_i} I(A:B).
\end{align}
...
We now move on to discuss quantum correlations. Whilst classical correlation measures have a clear operational meaning, quantum capacities 
...
Entanglement Assisted Classical & Classical information & Quantum mutual information & See Ref.~\cite{PhysRevLett.83.3081} \\
