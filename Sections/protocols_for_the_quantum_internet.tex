...
Another common non-linear transformation is squeezing, discussed in Sec.~\ref{sec:squeezed_prep}. This implements the unitary operator\index{Squeezing operator},
\begin{align}
