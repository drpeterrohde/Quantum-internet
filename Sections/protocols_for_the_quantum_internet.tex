...
\begin{figure}[!htb]
	...
	\caption{Probability of a multiplexed detector inferring the correct number of photons with $n$ incident photons across $m$ balanced modes. The detectors have perfect efficiency, \mbox{$\eta=1$}. $n$ ranges from $1$ (top) to $5$ (bottom). All curves asymptotically approach \mbox{$P_n=1$} for large $m$.}\label{fig:multiplexed_pd}
\end{figure}
