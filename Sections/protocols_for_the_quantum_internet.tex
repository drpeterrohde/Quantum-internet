...
\subsection{Open-destination quantum state teleportation}\index{Open-destination quantum state teleportation}\label{sec:open_dest_q	st}
...
\end{align}
Performing this contraction repeatedly ultimately reduces us all the way down to a single Bell pair.
