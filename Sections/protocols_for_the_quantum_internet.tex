...
\begin{figure}[!htbp]
	...
	\caption{An array of quantum-enabled telescopes, paired with one another via Bell-pairs, distributed over a quantum network.}\label{fig:telescope_array}\index{Telescope arrays}
\end{figure}
