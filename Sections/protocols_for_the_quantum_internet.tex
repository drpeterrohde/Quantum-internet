...
\end{align}
\captionspacefig \caption{Quantum non-demolition measurement of a single qubit. $\hat{M}$ is the measurement operator applied during measurement to the ancillary state, which may be destructive. The primary qubit has now been projected onto the measurement outcome $\hat{M}$, but has not been destroyed.}\index{Quantum non-demolition measurement (QND).}\label{fig:QND_circ}
\end{figure}
