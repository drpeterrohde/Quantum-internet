...
\subsection{Quantum-enhanced telescopy}\index{Quantum-enhanced telescopy}

\comment{To do}

\begin{align}
\ket{\psi} = \frac{1}{\sqrt{2}}(\ket{0}_A\ket{1}_B + e^{i\phi}\ket{1}_A\ket{0}_B).	
\end{align}
...
\begin{figure}[htpb]
\includegraphics[width=0.475\textwidth]{telescopy}
\caption{\comment{To do}.}\label{fig:telescopy}\index{Quantum-enhanced telescopy}	
\end{figure}

\cite{bib:PhysRevLett.109.070503}