...
\begin{figure}
\includegraphics[width=0.9\columnwidth]{snowflake_graph}
\caption{Micro-cluster state comprising a regular tree sturcture, with branching parameter \mbox{$b=4$} and depth \mbox{$d=4$}.} \label{fig:snowflake_graph}
\end{figure}
