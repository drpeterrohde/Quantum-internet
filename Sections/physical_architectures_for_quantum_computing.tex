...
\paragraph{Easy problems}\index{Easy linear optics sampling problems}
...
\item Coherent states are considered classical states (i.e laser light) with strictly positive Wigner functions\index{Wigner function}.
