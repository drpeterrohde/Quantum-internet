...
\begin{figure}[!htb]
\includegraphics[width=0.5\columnwidth]{microcluster_linear}
\caption{\comment{To do}} \label{fig:linear_graph}\index{Linear micro-cluster state}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.5\columnwidth]{microcluster_plus}
\caption{\comment{To do}} \label{fig:plus_graph}\index{+-micro-cluster state}
\end{figure}

\begin{figure}[!htb]
\includegraphics[width=0.4\columnwidth]{microcluster_star}
