...
\caption{Construction of a 2-mode, polarisation-encoded, photonic parity gate using an ancillary qubus coherent state, mediating photonic interactions via weak cross-Kerr non-linearities.}\label{fig:weak_ck_parity}	
\end{figure*}
