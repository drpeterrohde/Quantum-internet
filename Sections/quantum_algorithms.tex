...
\begin{enumerate}
    \item $\Box$
\end{enumerate}
\includegraphics[width=\textwidth]{shor_circuit}
}
\end{mdframed}
...
\caption{\label{fig:2DHLFgrid} Implementation of the HLF problem on a 2D grid. The qubits are represented as green circles (some omitted for clarity), and CZ gates are drawn in red.\comment{Better explanation}}
\end{figure}
