...
\else
\includegraphics[width=0.55\textwidth]{shor_circuit}
\fi
\end{center}
}
\end{mdframed}
...
\captionspacefig \caption{\label{fig:2DHLFgrid} Implementation of the HLF problem on a 2D grid. The qubits are represented as green circles (some omitted for clarity), and CZ gates are drawn in red.\comment{Better explanation}}
\end{figure}
