...
Assuming all gate operations are perfect and the only place where the 
...
Correction for $X$-errors occurs by treating each block of three qubits in the code identically to the three qubit code
[Algorithm \ref{alg:three_QEC}].  Phase errors 
($Z$-errors) are corrected by examining the sign differences between the 
three blocks.  
