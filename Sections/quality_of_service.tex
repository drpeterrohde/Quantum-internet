...
More concretely, we distribute two Bell pairs of fidelity $F$ between Alice and Bob, who perform local operations to reduce them to a single Bell pair of higher fidelity,
\begin{align}
\ket{\Phi^+_F}_{A,B}\otimes\ket{\Phi^+_F}_{A,B} \to \ket{\Phi^+_{F'}}_{A,B},
\end{align}
where,
\begin{align}
F'>F.	
