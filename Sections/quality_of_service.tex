...
Another approach is to error correct on Gaussian states using non-Gaussian operations\cite{PhysRevA.67.062320}, similar to the entanglement distillation protocol. It is unclear which one is the most advantageous.
