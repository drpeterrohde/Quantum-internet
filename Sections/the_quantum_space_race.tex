...
A third experiment performed QKD in a satellite-to-ground\index{Satellite-to-ground} configuration, where the ground station was at Xinglong \cite{bib:liao2017satellite}. The protocol that was used was the decoy-state BB84\index{Decoy-states}\index{BB84 protocol} protocol, which is robust against a photon-number splitting attack\index{Photon-number splitting attack}. A key-rate of between $1-12$kbit/s was achieved while the satellite was visible, depending upon the relative location in the sky (see Fig.~\ref{fig:space_4}(d)).
...
\caption{Satellites employing quantum technologies from various groups across the world: Japan \cite{bib:horiuchi2015view}, Italy \cite{bib:vallone15}, Canada \cite{bib:jennewein2014qeyssat}, Singapore \cite{bib:tang2016generation}, and China \cite{bib:gibney16}. \comment{Tim: do we have figure permission for this?}}
\label{fig:space_2}
\end{figure*}
...
\begin{figure}[htpb]
	\includegraphics[width=0.47\textwidth]{satellite_constellation}
