...
\captionspacefig \caption{\comment{to do, REDO PI LINES}}\label{fig:ZKP_graph}
\end{figure*}
...
\begin{enumerate}
	...
	\end{align}
	\item Victor is unable to determine $\pi$ from either scenario alone. But someone could if they knew both isomorphisms simultaneously, since,
	\begin{align}
	...
	\end{align}
	\item With confidence \mbox{$1-P_\text{deceive}$}, Victor knows that Peggy knows $\pi$ for the isomorphism \mbox{$G_1\sim G_2$}.
	\item $\Box$
\end{enumerate}}
\end{mdframed}
