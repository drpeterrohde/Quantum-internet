...
\begin{definition}[Static computational return]\index{Static computational return} The static computational return is the classical-equivalent processing power of a user's time-share, where the user has a fixed investment of one qubit, whereas the network is allowed to expand over time arbitrarily (e.g according to a quantum Moore's Law),
\begin{align}
...
Graphical examples for this relationship are equivalent to those presented earlier in Fig.~\ref{fig:NPSF}.
