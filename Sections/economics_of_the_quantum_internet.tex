...
\caption{Examples of the temporal dynamics of the cost of computation for different scaling functions and exponential growth rates. Units are \mbox{$C_0=N_0=n=1$}.\comment{Redo these}}\label{fig:econ_cost_of_comp}
\end{figure}
