...
\end{align}
based on the network growth postulate (Pos.~\ref{post:net_growth})\index{Network growth postulate} and employing a combined computational scaling function\index{Combined computational scaling function} (Def.~\ref{def:comb_sc_func}). The dollar-value of current net computational power of the entire network scales as,
\begin{align}
...
\end{align}
which yields the time-depenent cost of computation postulate,
...
This implies,
\begin{postulate}[Spot price of computation]\index{Spot price of computation} The present-day (\mbox{$t=0$}) spot price of a computation is,
\begin{align}
...
\subsubsection{The quantum stockmarket}\index{Quantum stockmarket}
