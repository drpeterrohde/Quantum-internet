...
\begin{itemize}
	\item Geo-strategic competition\index{Geo-strategic politics}: competing nation states or enterprises may not want essential infrastructure to be located entirely offshore, placing them at the mercy of their strategic competitors.
...
Much like the classical internet, it's to be expected the network that will emerge will approximate a scale-free network (Sec.~\ref{sec:scale_free_networks})\index{Scale-free networks}, with a very hierarchical structure, following a Pareto distribution\index{Pareto distribution} in hub-size.
