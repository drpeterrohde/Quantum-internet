...
The first question to ask is, how do mixed strategies\index{Mixed strategies} affect cooperation? To perform this analysis, assume that $X$ has chosen a mixed strategy comprising a combination of \textsc{License} and \textsc{Unify}. In the example shown in Fig.~\ref{fig:game_theory_4}, this results in a utility value of 4 for $X$, represented by the vertical dotted line.
