...
\end{align}
where there are $N$ players, all engaging with one another using licensing only. Here, $r_{i\to j}$ denotes the proportion of $i$'s compute-time licensed to $j$, which are normalised for all users such that,
\begin{align}
