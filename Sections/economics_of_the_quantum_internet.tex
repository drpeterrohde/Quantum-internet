...
\begin{enumerate}
	...
	\end{align}
	\item Alice places into escrow Bob's $reward$ for processing her data,
	\begin{align}
		escrow.hold(reward)
	\end{align}
