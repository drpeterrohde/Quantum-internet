...
\begin{itemize}
\item We acknowledge Gavin Brennen, Joseph Clark, Eric Cavalcanti, Charlotte Bridault, Marco Tomamichel, Jonathan Olson, Samuel Marks \& Darryl Veitch \comment{Remove, since author} for helpful discussions.
...
\item We thank almost unethical quantities of 1,3,7-Trimethylxanthine\index{Caffeine} for aiding in the motivation for this work.
\end{itemize}