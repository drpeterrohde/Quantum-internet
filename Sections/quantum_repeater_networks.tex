...
\captionspace \caption{Plot of the increased fidelity and success probability for entanglement purification for a mixture of two Bell states with initial fidelity $F$. The dashed lines show how multiple pairs with an initial fidelity $F=0.7$ can be purified iteratively to a final fidelity above 0.95.} 
...
\captionspace \caption{Transmission of a quantum signal using loss-based error correction codes in a quantum network.}\label{fig:repeaters_9}
\end{figure}
