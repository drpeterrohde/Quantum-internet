...
\dropcap{T}{he} laws of quantum mechanics are inherently different to those of classical mechanics in virtually every way, and bring with them their own unique notation for:
\begin{itemize}
...
\subsection{Features of quantum mechanics}\index{Characteristics of quantum mechanics}
...
The partial trace is a linear operator defined as satisfying the following properties\index{Partial trace!Properties},
\begin{align}
