...
\begin{table}[!htb]
	\begin{tabular}{|c|c|}
		\hline
  		...
  		\hline
  		\rowcolor{GreenYellow} Cluster state preparation (fusion gates) & HOM \\
  		\rowcolor{GreenYellow} Entanglement purification & HOM \\
  		\rowcolor{GreenYellow} Entanglement swapping & HOM \\ 
  		\rowcolor{GreenYellow} Matter qubit entangling operations & HOM \\
  		\rowcolor{GreenYellow} Partial Bell state measurements & HOM \\
   		\rowcolor{GreenYellow} Quantum gate teleportation & HOM \\
  		\rowcolor{GreenYellow} Quantum state teleportation & HOM \\
  		\rowcolor{GreenYellow} Superdense coding & HOM \\
  		\hline
  		\rowcolor{Lavender} {\sc BosonSampling} & MZ \\
