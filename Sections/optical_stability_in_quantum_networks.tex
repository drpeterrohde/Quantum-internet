...
In Table.~\ref{table:summary_inter} we summarise the network protocols discussed in Part.~\ref{part:protocols} in terms of the types of interference they rely upon. This creates a picture of which are more realistic from a near-term engineering perspective.
