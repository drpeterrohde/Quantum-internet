...
\begin{figure}[!htbp]
	\includegraphics[width=0.475\textwidth]{wavepacket} \\
	\captionspace \caption{(top) A photonic wave-packet of the form of Eq.~(\ref{eq:wavepacket_modulated}), with Gaussian temporal envelope of width $\sigma$ (orange), shifted by a carrier frequency $\omega_0$ (blue).} \label{fig:HOM_vs_MZ}
\end{figure}
...
\begin{figure}[!htbp]
	\includegraphics[width=0.475\textwidth]{MZ_setup} \\
	\includegraphics[width=0.475\textwidth]{MZ}
...
\begin{figure}[!htbp]
	...
	\includegraphics[width=0.475\textwidth]{HOM}
...
\begin{table}[!htbp]
	\begin{tabular}{|c|c|}
    	...
    	\hline
	\end{tabular}
	\captionspace \caption{Summary of the major quantum network protocols presented in Sec.~\ref{sec:protocols_quant_int}, and their required type of interference.}\index{Interferometric requirements}\label{table:summary_inter}
\end{table}
