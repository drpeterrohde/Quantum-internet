...
In the same way that information can be encoded using the displacement operator, in the form of coherent states, we can encode information via the squeezing operator\index{Squeezing operator},
