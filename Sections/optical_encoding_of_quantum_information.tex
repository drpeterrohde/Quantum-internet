...
\begin{figure}[!htb]
	...
	\caption{The family of Hermite functions are an example of an orthonormal basis of continuous functions that could be utilised in the spatio-temporal encoding of qudits into photonic wave-packets.\comment{Redo original figure}}\index{Hermite functions}
\end{figure}
