...
In the same way that information can be encoded using the displacement operator via coherent states, we can encode information via the single-mode squeezing operator\index{Squeezing operator},
