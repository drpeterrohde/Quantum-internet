...
\end{align}
where \mbox{$\xi  = r e^{i \varphi}\in \mathbb{C}$}, $r$ is known as the squeezing parameter\index{Squeezing parameter}, which will determine the magnitude of the squeezing and \mbox{$\varphi \in [0, 2\pi]$} denotes that axis along which the squeezing is taking place.
