...
\begin{figure}[!htb]
	\includegraphics[width=0.475\textwidth]{error_averaging_map_reduce}
...
\if 2\pubmode
\begin{figure}[!htbp]
	\includegraphics[width=0.4\textwidth]{cluster_ident_long}
...
\if 2\pubmode
\begin{figure}[!htbp]
\includegraphics[width=0.35\textwidth]{module_long}
