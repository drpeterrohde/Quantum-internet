...
\subsubsection{Distributed unitary error averaging}\index{Unitary error averaging}\index{Distributed unitary error averaging}
...
\begin{figure}[!htb]
	\includegraphics[width=0.47\textwidth]{error_averaging_map_reduce}
