...
\subsubsection{Digital signatures} \index{Digital signatures}
...
\subsubsection{Hashing} \index{Hashing}

\comment{To do. Collisions.}
...
The mining process is based upon the computational hardness of inverting SHA256 hashing\index{Hashing}\index{SHA256}. A legitimate Bitcoin is defined by a string with a hash satisfying a thoughtfully chosen constraint, which associates computational complexity with the mining process, and hence computational integrity of the money supply.
