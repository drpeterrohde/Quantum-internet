...
\subsection{One-time pad cipher}\index{One-time pad cipher}
...
\subsection{Brute-force}\index{Brute-force attacks}\label{sec:brute_force_attack}
...
\subsection{Quantum key distribution} \label{sec:QKD} \index{Quantum key distribution}
