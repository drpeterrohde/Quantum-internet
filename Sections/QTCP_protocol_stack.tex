...
\end{enumerate}}
\end{mdframed}
\caption{The goal of the \textsc{Reconstruction} layer, is to take a collection of received \textsc{Packets} and reassemble them into the \textsc{Message}. \comment{Not referenced in text!}} \label{alg:reconstruction}
\end{table}
...
\subsubsection{Quality of service} \label{sec:QOS} \index{Quality of service layer}
