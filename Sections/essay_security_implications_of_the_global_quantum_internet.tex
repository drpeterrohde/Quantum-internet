...
\begin{figure}[!htb]
\includegraphics[width=0.47\textwidth]{trump_tweet}
\caption{The Presidential response to Alg.~\ref{alg:russian}.}\label{fig:trump_tweet}\index{Trump}\index{Sad}\index{Covfefe}
\end{figure}
