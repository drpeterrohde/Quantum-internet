...
\end{enumerate}}
\end{mdframed}
\captionspace \caption{High-level structure of transport layer implementation of multi-packet operations.}\index{Multi-packet operations} \label{alg:trans_multi_packet}
\end{table}
...
\end{enumerate}}
\end{mdframed}
\captionspace \caption{Algorithm for combining efficiency metrics in a multi-packet protocol.} \label{alg:combine_eff}
\end{table}
...
\end{enumerate}}
\end{mdframed}
\captionspace \caption{Transport layer algorithm for combining decoherence rates in a multi-packet protocol.} \label{alg:combine_lat}
\end{table}
...
\end{enumerate}}
\end{mdframed}
\captionspace \caption{Transport layer algorithm for combining latencies in a multi-packet protocol.} \label{alg:combine_lat}
\end{table}
...
\end{enumerate}}
\end{mdframed}
\captionspace \caption{Transport layer algorithm for combining dollar costs in packet teleportation.} \label{alg:combine_dol}
\end{table}
