...
\comment{A homomorphic encryption scheme is made up of four algorithms: a key generation algorithm, {\sc KeyGen}, an encryption algorithm, {\sc Encrypt}, an evaluation algorithm, {\sc Evaluate}, and a decryption algorithm, {\sc Decrypt}. The four algorithms have the following inputs and outputs:
\begin{itemize}
